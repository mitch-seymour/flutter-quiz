          ...
          children: <Widget>[
            new Container(
              ...
              child: new Transform.rotate(
                child: new Icon(widget.isCorrect == true ? Icons.done : Icons.clear, size: _iconAnimation.value * 80),
                angle: _iconAnimation.value * 2 * PI,
              )
            ),
            new Padding(padding: new EdgeInsets.only(bottom: 20.0)),
            new Text(widget.isCorrect == true ? "Correct" : "Wrong", style: new TextStyle(color: Colors.white, fontSize: 30.0))
          ],
        )
      )
    );
